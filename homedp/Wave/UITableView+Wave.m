...
- (void)animationStart:(NSArray *)array
{
    ...
    CGPoint beginPoint = CGPointMake(cell.frame.size.width*i*1.8, originPoint.y);
    ...
    move.keyTimes=@[[NSNumber numberWithFloat:0.0],[NSNumber numberWithFloat:0.9],[NSNumber numberWithFloat:0.9],[NSNumber numberWithFloat:1.]];
